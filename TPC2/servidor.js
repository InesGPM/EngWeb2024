...
http.createServer(function(req, res) {
    ...
    if (q === '') {
        serveFile('view/index.html', 'text/html; charset=utf-8', res)
    } else if (q === 'w3.css') {
        ...
        fs.readFile('mapa-virtual.json', function(err, data) {
            if (err) {
                ...
                if (ids.includes(q)) {
                    serveFile('cidades/' + q + '.html', 'text/html; charset=utf-8', res)
                } else {
                    serveFile('view/erro.html', 'text/html; charset=utf-8', res)
                }
            }
        });
    } else {
